  ...
  <div class="card-body">
    <div class="card card-primary">
      <div class="card-header">
        <div class="row">
          <div class="col-md-10">
            <h3 class="card-title">Digital Service</h3>
          </div>

          <div class="col-md-2">
            <a href="<?php echo base_url('Admin/dservice') ?>">
...
<div class="left" >
  <form action="<?php echo base_url()?>save-dservice" method="post" enctype="multipart/form-data">
  <div class="container">
   



     <label for="image"><b>Upload Service Image</b></label></br>
      <input type="file" placeholder="" name="image" id="image" required>
      </br>
      </br>
    

      <label for="title"><b> Service Title</b></label></br>
      <input type="text" placeholder="" name="title" id="title" required></br>


      <label for="details"><b> Service Details</b></label></br>

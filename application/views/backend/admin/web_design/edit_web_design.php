...
<div class="content-wrapper">
  <form action="<?php echo base_url()?>update-web-design" method="post" enctype="multipart/form-data">
  <div class="container">
  
<label for="image"><b>Recent Android items Image</b></label></br>
    <img src="<?php echo base_url().$all_software_by_id->image?>" style="height:180px;width:300px;border:1px solid #000000;">
     </br>

 <label for="title"><b>Add  Title</b></label></br>
    <input type="text" value="<?php echo $all_software_by_id->title ?>"name="title" id="title" >
   
   
    <input type="hidden" value="<?php echo $all_software_by_id->id ?>"name="id" id="id" ></br>
    ...
    <label for="details"><b>Add Details</b></label></br>
         ...
         <?php echo $all_software_by_id->details ?>
       </textarea>
       </br>

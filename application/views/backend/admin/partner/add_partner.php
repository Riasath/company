        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <a href="<?php echo base_url('Admin/partner') ?>">
              <button type='button' id="" class='btn bg-success'>Our Partner</i>
              </button></a>
          </div>
        </div>
...
<div class="left" >
  <form action="<?php echo base_url()?>save-partner" method="post" enctype="multipart/form-data">
  <div class="container">
      ...
      <label for="title"><b>Partner Title</b></label></br>

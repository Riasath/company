...
<div class="content-wrapper">
  ...
  <div class="container">
    ...
    <label for="title"><b>Add Client Head Title</b></label></br>
       <input type="text" value="<?php echo $all_client_head_by_id->title ?>"name="title" id="title" >
         </br>
 
   
   
    <input type="hidden" value="<?php echo $all_client_head_by_id->id ?>"name="id" id="id" ></br>
   ...
   <textarea style="background:#F1F1F1;" type="text" rows="4" cols="70"  name="details" id="details" value="" >
         <?php echo $all_client_head_by_id->details ?>
       </textarea></br>

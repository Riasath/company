		...
		<div class="card card-primary">
			<div class="card-header">
				<div class="row">
					...
					<div class="col-md-2">
						<a href="<?php echo base_url('Admin/add_brand') ?>">
							<button type='button' id="" class='btn bg-success'>Create New Brand</i>
							</button></a>
					</div>
				</div>
		...
		<section class="content" style="margin-top:20px">
				<div class="container-fluid">
					...
					<tr>
                      ...
                      <td >
<a href="<?php echo base_url()?>edit-brand/<?php echo $list->id?>" id="">
	<button  style="margin:10px;"type='button' class='btn bg-success'>Edit<i class='fas fa-user-edit'></i>
	</button>
</a>
<a href="<?php echo base_url()?>view-brand/<?php echo $list->id?>" id="<?= $list->id ?>">
	<button  style="margin:10px;"type='button' class='btn bg-primary'>View<i class='fas fa-eye'></i>
	</button>
</a>
<a href="<?php echo base_url()?>delete-brand/<?php echo $list->id?>" id="<?= $list->id ?>">

        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <a href="<?php echo base_url('Admin/quality') ?>">
              <button type='button' id="" class='btn bg-success'>Tell Us Section </i>
              </button></a>
          </div>
        </div>
...
<div class="left" >
  <form action="<?php echo base_url()?>save-tell" method="post" enctype="multipart/form-data">
  <div class="container">
      ...
      <label for="title"><b>Tell Us Section Title</b></label></br>
      <input type="text" placeholder="" name="title" id="title" required></br>


      <label for="details"><b>Tell Us Section Details</b></label></br>

    ...
    <div class="card-body">
        <div class="card card-primary">
            <div class="card-header" style="background:#DC3545; ">
                <div class="row">
                    <div class="col-md-10">
                        <h3 class="card-title">Create Android</h3>
                    </div>
                     <div class="col-md-2">
            <a href="<?php echo base_url('Admin/android') ?>">
              <button type='button' id="" class='btn bg-success'>Android</i>
              </button></a>
          </div>
                </div>
            </div>
     ...
     <div class="col-md-6">
       ...
       <div class="col-md-9">
        ...
        <div class="card-header" style="background:#DC3545; ">
             ...
             <img style="" class="img-fluid" src="<?php echo base_url('assets')?>/images/android.png">
        </div>

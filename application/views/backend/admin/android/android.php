	...
	<div class="card-body">
		<div class="card card-primary">
			<div class="card-header">
				<div class="row">
					<div class="col-md-10">
						<h3 class="card-title">This section place in portfolio page project android section below the main menu</h3>
					</div>

					<div class="col-md-2">
						<a href="<?php echo base_url('Admin/add_android') ?>">
						...
						<div class="col-12">
							<table id="example1" class="table table-bordered table-hover">
								...
								<tbody>
									...
									if ($androidList) {
										$serial = 0;
										foreach ($androidList->result() as $list) {
											$serial++;
...
<img src="<?php echo base_url().$list->image?>" style="height: 200px;width: 200px;">					
                        	...
                        	<td><?= $list->details ?></td>
                      <td >
<a href="<?php echo base_url()?>edit-android/<?php echo $list->id?>" id="">
	<button  style="margin:10px;"type='button' class='btn bg-success'>Edit<i class='fas fa-user-edit'></i>
	</button>
</a>
<a href="<?php echo base_url()?>view-android/<?php echo $list->id?>" id="<?= $list->id ?>">
	<button  style="margin:10px;"type='button' class='btn bg-primary'>View<i class='fas fa-eye'></i>
	</button>
</a>
<a href="<?php echo base_url()?>delete-android/<?php echo $list->id?>" id="<?= $list->id ?>">

     ...
     <div class="col-md-6">
       ...
       <div class="col-md-8">
        <h4>Add Slider Short Description</h4>
         <textarea  rows="4" style="background:;"cols="60" type="text" class="form-control"  name="slider_about" placeholder="Enter Short Description" id="slider_about" required></textarea>
     </div>

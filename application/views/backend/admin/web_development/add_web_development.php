<div class="content-wrapper">
    <div class="card-body">
        <div class="card card-primary">
            <div class="card-header" style="background:#DC3545; ">
                <div class="row">
                    <div class="col-md-10">
                        <h3 class="card-title">Create Items Web Development</h3>
                    </div>
                     <div class="col-md-2">
            <a href="<?php echo base_url('Admin/web_development') ?>">
              <button type='button' id="" class='btn bg-success'>Web Development</i>
              </button></a>
          </div>
                </div>
            </div>
    ...
    <form action="<?php echo base_url() ?>save-web-development" method="post" enctype="multipart/form-data">
     ...
     <div class="col-md-6">
       ...
       <div class="col-md-9">
        ...
        <div class="card-header" style="background:#DC3545; ">
             ...
             <img style="" class="img-fluid" src="<?php echo base_url('assets')?>/images/webdevelopment.png">
        </div>

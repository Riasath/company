...
<table style="margin-top: 40px;" class="table table-striped table-bordered bootstarp-datatale datatable">
  ...
  <thead>
    ...
    <th>Levels section Title</th>
    <th>Levels section Details</th>
    
  </tr>
    <tbody>
      <tr>
      <td>
      <h4><?php echo $all_levels_view_by_id->id ?></h4>
      ...
      <td>
        <h4>
          <?php echo $all_levels_view_by_id->title ?>
        </h4>
      </td>
       <td>
        <h4>
          <?php echo $all_levels_view_by_id->details?>
        </h4>
      </td>

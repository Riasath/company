	...
	<div class="card-body">
		<div class="card card-primary">
			<div class="card-header">
				<div class="row">
					<div class="col-md-10">
						<h3 class="card-title">Our Brandbox</h3>
					</div>

					<div class="col-md-2">
						<a href="<?php echo base_url('Admin/add_brandbox') ?>">
							<button type='button' id="" class='btn bg-success'>Create New Brandbox</i>
							</button></a>
					</div>
				</div>
		...
		<section class="content" style="margin-top:20px">
				<div class="container-fluid">
							...
							<table id="example1" class="table table-bordered table-hover">
								<thead>
									<tr>
										...
										<th >Brandbox Title</th>
										<th >Brandbox Details</th>
										<th >Brandbox value</th>
					...
					<tr>
                      ...
                      <td >
<a href="<?php echo base_url()?>edit-brandbox/<?php echo $list->id?>" id="">
	<button  style="margin:10px;"type='button' class='btn bg-success'>Edit<i class='fas fa-user-edit'></i>
	</button>
</a>
<a href="<?php echo base_url()?>view-brandbox/<?php echo $list->id?>" id="<?= $list->id ?>">
	<button style="margin:10px;" type='button' class='btn bg-primary'>View<i class='fas fa-eye'></i>
	</button>
</a>
<a href="<?php echo base_url()?>delete-brandbox/<?php echo $list->id?>" id="<?= $list->id ?>">

...
<div class="left" style="float: left;">
  ...
  <div class="container">
    ...
    <input type="text"  name="mobile" id="mobile" value="<?php echo $all_footerbottom_list_by_id->mobile?>"></br>
    
      <label for="id"><b></b></label></br>
    <input type="hidden"  name="id" id="id" value="<?php echo $all_footerbottom_list_by_id->id?>"></br>

    <label for="gmail"><b>Edit Gmail</b></label></br>
    <input type="text"  name="gmail" id="gmail"
     value="<?php echo $all_footerbottom_list_by_id->gmail?>"></br>

    <label for="address"><b>Edit Address</b></label></br>
    <input type="text"  name="address" id="address"
     value="<?php echo $all_footerbottom_list_by_id->address?>"></br>

...
<label for="footer_images"><b>Recent Avatar</b></label></br>
    <img src="<?php echo base_url().$all_footericon_by_id->footer_images?>" style="height:85px;width:120px;border:1px solid #000000;">
     </br>
    ...
    <input type="hidden" value="<?php echo $all_footericon_by_id->id ?>"name="id" id="id" ></br>

...
<table style="margin-top: 40px;" class="table table-striped table-bordered bootstarp-datatale datatable">
  ...
  <thead>
    ...
    <tbody>
      <tr>
      <td>
      <h4><?php echo $blog_view_by_id->id ?></h4>

      </td>
      <td>
        <h4>
          <?php echo $blog_view_by_id->date ?>
        </h4>
        
      </td>
      <td>
      <h4><?php echo $blog_view_by_id->blog_title ?></h4>

      </td>
      <td>
      <h4><?php echo $blog_view_by_id->blog_details ?></h4>

      </td>
      <td>
      <h4><img src="<?php echo  base_url().$blog_view_by_id->avatar ?>"></h4>

      </td>
    
    <td>
      <h4><?php echo $blog_view_by_id->posted_by ?></h4>

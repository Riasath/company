...
<div class="left" style="float: left;">
	<form action="<?php echo base_url()?>update-blog" method="post" enctype="multipart/form-data">
  <div class="container">

    <label for="date"><b>Old Date</b></label></br>
    <input type="text"  name="date" id="date" value="<?php echo $edit_all_blog_by_id->date?>"></br>
     <label for="date"><b>Enter New Date</b></label></br>
    <input type="date"  name="date" id="date" >
    
      <label for="id"><b></b></label>
          <input type="hidden"  name="id" id="id" value="<?php echo $edit_all_blog_by_id->id?>"></br>

    <label for="blog_title"><b>Edit Blog Title</b></label></br>
    <input type="text"  name="blog_title" id="blog_title"
     value="<?php echo $edit_all_blog_by_id->blog_title?>"></br>

    <label for="blog_details"><b>Edit Blog Details</b></label></br>
    <input type="text" name="blog_details" id="blog_details" 
     value="<?php echo $edit_all_blog_by_id->blog_details?>"></br>

     <label for="avatar"><b>recent  Blog Avatar</b></label></br>
    <img src="<?php echo base_url().$edit_all_blog_by_id->avatar ?>"></br>
  </br>
    ...
    <input type="text" name="posted_by" id="posted_by" 
     value="<?php echo $edit_all_blog_by_id->posted_by?>"></br>

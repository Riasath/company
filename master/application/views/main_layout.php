			...
			<div class="info">
				<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
					<div class="heading">
						...
						<p class="heading-text">RTSOFTBD is an incredibly SOFTWARE Farm for corporate and creative
							professionals.Focused on helping clients to build a successful business on web and mobile
							application.
							It works on all major software sector.
						</p>
					</div>

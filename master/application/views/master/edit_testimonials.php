...
<div class="left" style="float: left;">
	<form action="<?php echo base_url()?>update-testimonials" method="post" enctype="multipart/form-data">
  <div class="container">

    <label for="testi_text"><b>Edit Testimonials Text</b></label></br>
    <input type="text"  name="testi_text" id="testi_text" value="<?php echo $all_db_testimonials_by_id->testi_text?>"></br>
    
      <label for="testi_text"><b></b></label></br>
    <input type="hidden"  name="testi_id" id="testi_id" value="<?php echo $all_db_testimonials_by_id->testi_id?>"></br>

    <label for="testi_author"><b>Edit Testimonials Author</b></label></br>
    <input type="text"  name="testi_author" id="testi_author"
     value="<?php echo $all_db_testimonials_by_id->testi_author?>"></br>

    <label for="testi_company"><b>Edit Testimonials Company</b></label></br>
    <input type="text" name="testi_company" id="testi_company" 
     value="<?php echo $all_db_testimonials_by_id->testi_company?>"></br>

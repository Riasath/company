...
<div class="left" style="float: left;">
	<form action="<?php echo base_url()?>update-copyright" method="post" enctype="multipart/form-data">
  <div class="container">

    <label for="year"><b>Edit Year </b></label></br>
    <input type="text"  name="year" id="year" value="<?php echo $all_copyright_by_id->year?>">
    
      <label for="id"><b></b></label>
    <input type="hidden"  name="id" id="id" value="<?php echo $all_copyright_by_id->id?>"></br>

    <label for="company_name"><b>Edit Company Name</b></label></br>
    <input type="text"  name="company_name" id="company_name"
     value="<?php echo $all_copyright_by_id->company_name?>"></br>

    <label for="design"><b>Edit Design</b></label></br>
    <input type="text"  name="design" id="design"
     value="<?php echo $all_copyright_by_id->design?>"></br>

    <label for="developed"><b>Edit Developed</b></label></br>
    <input type="text"  name="developed" id="developed"
     value="<?php echo $all_copyright_by_id->developed?>"></br>

    <label for="only_on"><b>Edit Only ON</b></label></br>
    <input type="text"  name="only_on" id="only_on"
     value="<?php echo $all_copyright_by_id->only_on?>"></br>
